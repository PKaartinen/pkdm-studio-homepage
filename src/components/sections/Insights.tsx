        ...
        <div className="mt-14 grid gap-5 md:grid-cols-3">
          {insights.map((post, i) => (
            <Reveal key={post.title} delay={i * 0.07}>
              {/* Stub link — point to a real blog route when published */}
              <a
                href="#insights"
                className="group flex h-full flex-col justify-between gap-8 rounded-2xl border border-white/[0.07] bg-white/[0.02] p-7 transition-colors duration-300 hover:border-accent-soft/25"
              >
                <div>
