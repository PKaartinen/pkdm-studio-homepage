...
export const socialIcons: Record<string, (p: IconProps) => ReactElement> = {
  ...
  youtube: ({ className = "h-5 w-5" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M21.58 7.19a2.5 2.5 0 0 0-1.76-1.77C18.25 5 12 5 12 5s-6.25 0-7.82.42A2.5 2.5 0 0 0 2.42 7.2 26.2 26.2 0 0 0 2 12a26.2 26.2 0 0 0 .42 4.81 2.5 2.5 0 0 0 1.76 1.77C5.75 19 12 19 12 19s6.25 0 7.82-.42a2.5 2.5 0 0 0 1.76-1.77A26.2 26.2 0 0 0 22 12a26.2 26.2 0 0 0-.42-4.81ZM10 15.13V8.87L15.45 12 10 15.13Z" />
    </svg>
  ),
  tiktok: ({ className = "h-5 w-5" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M16.6 3c.36 1.94 1.63 3.45 3.9 3.6v2.62c-1.42.14-2.84-.33-3.9-1.13v5.86A5.62 5.62 0 1 1 11 8.36c.34 0 .68.03 1 .1v2.77a2.94 2.94 0 0 0-1-.17 2.9 2.9 0 1 0 2.92 2.9V3h2.68Z" />
    </svg>
  ),
